...
## NOTE: This repo uses [Gitmoji Standards](https://gitmoji.carloscuesta.me) for commit msgs

For example, if a normal commit would be like:
```
Add CPU arch filter scheduler support
```
A gitmoji standard commit would be like:

```
✨ Add CPU arch filter scheduler support
```

## Basic Commit Standard
...
This convention matches up with commit messages
